...
.PHONY: dist
dist: dist/synth-a-py-1.4.0.tar.gz dist/synth_a_py-1.4.0-py3-none-any.whl

dist/synth-a-py-1.4.0.tar.gz dist/synth_a_py-1.4.0-py3-none-any.whl: $(shell find synth_a_py -type f -name '*.py')
	poetry build
